...
export function ManagerLayout() {
  ...
  const navLinkStyle = (active: boolean, collapsed: boolean): React.CSSProperties => ({
    ...
    background: active ? `rgba(${ACCENT_RGB},0.15)` : 'transparent',
  ...
  const sidebarContent = (mobile: boolean) => (
    <>
      ...
      <nav style={{ flex: 1, padding: '12px 8px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
        {NAV_ITEMS.map((item) => (
          <Link
            ...
            style={navLinkStyle(isActive(item.to), !mobile && !sidebarOpen)}
          >
      ...
      <div style={{ padding: '16px', borderTop: `1px solid rgba(${ACCENT_RGB},0.1)` }}>
    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#0f0e17' }}>
      ...
      <aside
        style={{
          ...
          borderRight: `1px solid rgba(${ACCENT_RGB},0.15)`,
