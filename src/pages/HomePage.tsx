...
export function HomePage() {
  ...
  const categories = Object.entries(CATEGORY_LABELS).filter(([k]) => k !== 'all');
    ...
    <div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${isDark ? 'bg-purple-500/30' : 'bg-purple-200'}`}>
              <Rocket className={`w-6 h-6 ${isDark ? 'text-purple-400' : 'text-purple-600'}`} />
            </div>
            <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>Giao hàng siêu tốc</h3>
          ...
          >
            <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${isDark ? 'bg-blue-500/30' : 'bg-blue-200'}`}>
              <Zap className={`w-6 h-6 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
            </div>
            <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>Trả góp 0%</h3>
            <p className={isDark ? 'text-gray-400' : 'text-gray-600'}>
          ...
          >
            <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-4 ${isDark ? 'bg-pink-500/30' : 'bg-pink-200'}`}>
              <Shield className={`w-6 h-6 ${isDark ? 'text-pink-400' : 'text-pink-600'}`} />
            </div>
            <h3 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>Bảo hành chính hãng</h3>
            <p className={isDark ? 'text-gray-400' : 'text-gray-600'}>
